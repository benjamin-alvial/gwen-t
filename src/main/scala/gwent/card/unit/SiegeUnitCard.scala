 ...
 * @version 0.1.3
 */
class SiegeUnitCard(private val name: String, private val strength: Int, private val ability: Ability) extends AbstractUnitCard(name, strength, ability) with Equals {
