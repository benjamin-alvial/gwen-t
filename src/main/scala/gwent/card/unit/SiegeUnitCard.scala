 ...
 * @version 0.1.5
 */
class SiegeUnitCard(private val name: String, private val strength: Int, private val ability: UnitAbility) extends AbstractUnitCard(name, strength, ability) with Equals {
